...
>
  ...
  {/* Standard Icons Wrapper - justify-start keeps it left-aligned */}
  <div className="bg-white rounded-2xl p-6 md:p-10 mb-6 flex justify-start items-center">
    <Image
      src="/img/recifree_icons.png"
      alt="ReciFree Icons"
      width={800}
      height={200}
      /* Removed mx-auto to keep it pinned to the left */
      className="w-auto max-w-[300px] md:max-w-[500px] h-auto"
    />
  </div>

  {/* Dietary Icons Wrapper - justify-start keeps it left-aligned */}
  <div className="bg-white rounded-2xl p-6 md:p-10 flex justify-start items-center">
    <Image
