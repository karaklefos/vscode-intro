          ...
          >
            <div className="glass-card rounded-3xl p-8 md:p-12">
              ...
              <p className="text-lg leading-relaxed">
                Savvy Pig is an intuitive financial saving app designed to
                empower users to take control of their finances. I created the
                concept, name, brand guidelines and overall design. By blending
                a professional tone with playful imagery, the app removes the
                intimidation of money management, simplifying expense tracking
                and savings goals to help users confidently achieve their
                milestones.
              </p>
            </div>
          </motion.section>
              ...
              <div className="overflow-x-auto pb-10 -mx-4 px-4 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent snap-x snap-mandatory flex items-start">
                <div className="flex gap-6 items-start">
                  {[
                    ...
                    {
                      name: "Sign Up",
                      Image: "/img/savvypig_mockup_signup.png",
                    },
                    {
                      name: "Dashboard",
                      Image: "/img/savvypig_mockup_dashboard.png",
                    },
                    { name: "Menu", Image: "/img/savvypig_mockup_menu.png" },
                    {
                      name: "Transactions",
                      Image: "/img/savvypig_mockup_transactions.png",
                    },
                  ].map((screen, index) => (
                    <div
                      key={index}
                      className="flex-shrink-0 w-64 md:w-72 rounded-2xl overflow-hidden glass-card snap-center border border-white/10 shadow-xl h-fit"
                    >
                      <Image
                        src={screen.Image}
              ...
              <div className="glass-card rounded-3xl p-8 md:p-12">
                ...
                <ul className="space-y-8">
                  <li>
                    ...
                    <p className="text-lg leading-relaxed">
                      I created SavvyPig by formulating a precise{" "}
                      <strong>problem statement</strong> and conducting a{" "}
                      <strong>comprehensive competitor analysis,</strong>{" "}
                      enabling me to determine the core features for this
                      responsive financial management application.
                    </p>
                  </li>
                  <li>
                    ...
                    <p className="text-lg leading-relaxed">
                      I crafted a professional yet welcoming{" "}
                      <strong>brand identity</strong> for SavvyPig, utilizing
                      primary colors symbolizing trust and growth, and{" "}
                      <strong>designing the logo</strong> for clear legibility
                  ...
                  <li>
                    ...
                    <p className="text-lg leading-relaxed">
                      I spearheaded the entire design phase, creating
                      comprehensive{" "}
                      <strong>
                        wireframes, interactive prototypes, and detailed mockups
                      </strong>{" "}
                      to build an accessible and engaging financial management
                      experience.
                    </p>
                  </li>
                  <li>
                    ...
                    <p className="text-lg leading-relaxed">
                      Through <strong>A/B testing and user testing</strong> I
                      validated SavvyPig's design effectiveness, gathering
                      crucial feedback to ensure the financial management
                      solution is intuitive and highly user-friendly.
                    </p>
                  </li>
                </ul>
              </div>
              ...
              <div className="glass-card rounded-3xl p-8 md:p-12">
                ...
                <ul className="space-y-6">
                  <li className="flex gap-4">
                    ...
                    <p className="text-lg leading-relaxed">
                      <strong>Track Expenses and Income:</strong> view detailed
                      transaction history, as well as log income within
                      categories.
                    </p>
                  </li>
                  <li className="flex gap-4">
                    <span className="text-accent text-xl">•</span>
                    <p className="text-lg leading-relaxed">
                      <strong>Set Savings Goals:</strong> define a goal name,
                      amount and a target completion date.
                    </p>
                  </li>
                  <li className="flex gap-4">
                    <span className="text-accent text-xl">•</span>
                    <p className="text-lg leading-relaxed">
                      <strong>Visualize Financial Data:</strong> access a
                      dashboard displaying spending categories, saving progress,
                      and view trends in financial habits over time.
                    </p>
                  </li>
                </ul>
              </div>
          ...
          >
            <div className="glass-card rounded-3xl p-8 md:p-12">
              ...
              <p className="text-lg text-muted-foreground italic">
                The highlighted portion represents the flow of the design you
                are seeing in this case study.
              </p>
            </div>
          </motion.section>
              ...
              <div className="overflow-x-auto pb-10 -mx-4 px-4 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent snap-x snap-mandatory flex items-start">
                <div className="flex gap-6 items-start">
                  {[
                    ...
                    {
                      name: "Dashboard",
                      Image: "/img/savvypig_low_dashboard.png",
                    },
                    {
                      name: "Transactions",
                      Image: "/img/savvypig_low_transactions.png",
                    },
                    {
                      name: "Category",
                      Image: "/img/savvypig_low_category.png",
                    },
                  ].map((screen, index) => (
                    <div
                      key={index}
              ...
              <div className="overflow-x-auto pb-10 -mx-4 px-4 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent snap-x snap-mandatory flex items-start">
                <div className="flex gap-6 items-start">
                  {[
                    ...
                    {
                      name: "Dashboard",
                      Image: "/img/savvypig_mid_dashboard.png",
                    },
                    {
                      name: "Transactions",
                      Image: "/img/savvypig_mid_transactions.png",
                    },
                    {
                      name: "Category",
                      Image: "/img/savvypig_mid_category.png",
                    },
                  ].map((screen, index) => (
                    <div
                      key={index}
              ...
              <div className="overflow-x-auto pb-10 -mx-4 px-4 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent snap-x snap-mandatory flex items-start">
                <div className="flex gap-6 items-start">
                  {[
                    ...
                    {
                      name: "Dashboard",
                      Image: "/img/savvypig_high_dashboard.png",
                    },
                    {
                      name: "Transactions",
                      Image: "/img/savvypig_high_transactions.png",
                    },
                    {
                      name: "Category",
                      Image: "/img/savvypig_high_category.png",
                    },
                  ].map((screen, index) => (
                    <div
                      key={index}
                      className="flex-shrink-0 w-64 rounded-2xl overflow-hidden glass-card snap-center border border-white/10 shadow-xl h-fit"
                    >
                      <Image
                        src={screen.Image}
              ...
              <div className="space-y-12">
                <div>
                  ...
                  <p className="text-lg leading-relaxed mb-12">
                    These colors convey a professional yet welcoming tone,
                    symbolizing both trust and growth.
                  </p>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    {[
                      ...
                      {
                        name: "Logotype",
                        Image: "/img/savvypig_logotypeface.png",
                      },
                      {
                        name: "Logo Outline",
                        Image: "/img/savvypig_logooutline.png",
                      },
                    ].map((logo, index) => (
                      <div
                        key={index}
                        className="rounded-2xl overflow-hidden glass-card bg-white p-8 flex items-center justify-center border border-gray-100"
                      >
                        <Image
                          src={logo.Image}
                          alt={logo.name}
              ...
              <div className="overflow-x-auto pb-10 -mx-4 px-4 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent snap-x snap-mandatory flex items-start">
                <div className="flex gap-6 items-start">
                  {[
                    ...
                    {
                      name: "Sign Up",
                      Image: "/img/savvypig_desktop_signup.png",
                    },
                    {
                      name: "Dashboard",
                      Image: "/img/savvypig_desktop_dashboard.png",
                    },
                  ].map((screen, index) => (
                    <div
                      key={index}
                      className="flex-shrink-0 w-[600px] rounded-2xl overflow-hidden glass-card snap-center border border-white/10 shadow-xl h-fit"
                    >
                      <Image
                        src={screen.Image}
